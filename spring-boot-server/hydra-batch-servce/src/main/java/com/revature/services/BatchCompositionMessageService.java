...
import com.revature.entities.Trainee;
...
//	private static final String TRAINEE_ROUTING_KEY = "JyoH3uRmktGn9MnW";
	 ...
	 * @return
	 */
	public Trainer sendTrainerRequest(Integer trainerId) {
		...
		return (Trainer) rabbitTemplate.convertSendAndReceive(
...
//	}
	 ...
	 * @return
	 */
	public List<Trainee> sendListTraineeRequest(Integer batchId){
		...
		return SimpleTraineeList.stream().map(x->(Trainee)x).collect(Collectors.toList());
	}
//	/**
//	 * 
//	 * @param batchId
...
//	}
	/**
	 * Sends Trainee Service a message to delete a batch that we are deleting
	 * @param batchId
	 */
	public void sendTraineeDeleteRequest(Integer batchId) {
